...
const sap = [
  {
    name: 'Relatórios SAP',
    description: 'Aprenda como fazer os relatórios do SAP B1.',
    href: '#',
    icon: ChartBarIcon
  },
  {
    name: 'Determinação Contábil',
    description: 'Aprenda a fazer determinação contábil.',
    href: '#',
    icon: CalculatorIcon
  },
  {
  ...
  {
    name: 'Add-ons',
    description: 'Treinamentos dos add-ons do TaxPlus.',
    href: '#',
    icon: Squares2X2Icon
  }
]
        ...
        <div className="flex items-center justify-between border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
          <div className="flex justify-start lg:w-0 lg:flex-1">
            <a href="/" className="text-2xl">
              Educ
              <span className="text-red-600 text-2xl">Ativus</span>
            </a>
          </div>
